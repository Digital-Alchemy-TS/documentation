...
- #Usage-Example/automation/sequence_match
...
> [!example] Example event from button press
...
> [!example] #Usage-Example/automation/sequence_match_proof_of_concept
...
> [!example] #Usage-Example/extended/lutron_pico
